...
function QuoteCard({ story }: { story: any }) {
  return (
    <motion.div
      className="relative w-[300px] md:w-[450px] h-[380px] rounded-3xl p-10 bg-[#0f1219] border border-white/5 group hover:border-amber-500/30 transition-all duration-500 flex flex-col justify-between shadow-2xl"
    >
      {/* Quote Icon */}
