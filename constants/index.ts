  ...
  items: [
    {
      ...
      author: "Mahady Rony",
      role: "Founder, Valancis",
      quote: "Agnos built our e-commerce foundation with a focus on high-performance scaling. We handle peak traffic with absolute confidence.",
      stat: "50k+ Users"
    },
    {
      id: 2,
      ...
      poster: "/placeholder-video.jpg",
      author: "Tamim",
      role: "Founder, Rokomferi",
      quote: "The bespoke ordering system Agnos developed for Rokomferi streamlined our logistics and payment flows significantly.",
      stat: "Zero Latency"
    },
    {
      id: 3,
      ...
      quote: "The school management system revolutionized our administration. From admission to results, everything is now synchronized.",
      stat: "2x Admin Speed"
    },
    {
      id: 4,
      ...
      quote: "Managing student records used to be a nightmare. Agnos simplified our entire operational workflow and saved us hours of work.",
      stat: "100% Digital"
    },
    {
      id: 5,
      ...
      role: "Modern Education Hub",
      quote: "Our transition to a digital-first school was seamless. Parents love the transparency and our staff loves the automation.",
